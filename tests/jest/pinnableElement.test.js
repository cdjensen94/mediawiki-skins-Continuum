jest.mock( '../../resources/skins.continuum.js/features.js' );
...
const pinnableElement = require( '../../resources/skins.continuum.js/pinnableElement.js' );
...
const initializeHTML = ( headerData ) => {
	...
	document.body.innerHTML = `<div id="pinned-container">
		...
		<div class="continuum-dropdown">
			<input type="checkbox" id="checkbox" class="continuum-menu-checkbox">
			<label for="checkbox" class="continuum-menu-heading ">
				<span class="continuum-menu-heading-label">Dropdown</span>
			</label>
...
describe( 'Pinnable header', () => {
	...
	test( 'updates pinnable header classes when toggle is pressed', () => {
		...
		const pinButton = /** @type {HTMLElement} */ ( document.querySelector( '.continuum-pinnable-header-pin-button' ) );
		const unpinButton = /** @type {HTMLElement} */ ( document.querySelector( '.continuum-pinnable-header-unpin-button' ) );
