...
const fs = require( 'fs' );
const stickyHeaderTemplate = fs.readFileSync( 'includes/templates/Continuum/StickyHeader.mustache', 'utf8' );
const buttonTemplate = fs.readFileSync( 'includes/templates/Continuum/Button.mustache', 'utf8' );
const iconTemplate = fs.readFileSync( 'includes/templates/Continuum/Icon.mustache', 'utf8' );
const sticky = require( '../../resources/skins.continuum.js/stickyHeader.js' );
...
const templateData = {
	...
	'data-sticky-header-toc-dropdown': {
		id: 'continuum-sticky-header-toc',
		class: 'mw-portlet mw-portlet-sticky-header-toc continuum-sticky-header-toc',
		'html-items': '',
		'html-continuum-menu-checkbox-attributes': 'tabindex="-1"',
		'html-continuum-menu-label-attributes': 'tabindex="-1"',
	...
	'data-button-start': {
		label: 'search',
		icon: 'search',
		class: 'cdx-button cdx-button--weight-quiet cdx-button--icon-only continuum-sticky-header-search-toggle',
		'array-attributes': [ {
			key: 'data-event-name',
			value: 'ui.continuum-sticky-search-form.icon'
		}, {
			key: 'tabindex',
			value: '-1'
		} ]
