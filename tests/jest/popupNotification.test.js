const popUpNotification = require( '../../resources/skins.continuum.js/popupNotification.js' );
...
describe( 'Popup Notification', () => {
	beforeEach( () => {
		...
		continuumPopupClass = 'continuum-popup-notification';
		activeNotification = [];
	...
	test( 'add', async () => {
		...
		expect( activeNotification[ testId ].$element[ 0 ].classList
			.contains( continuumPopupClass ) ).toBe( true );
	} );
