...
const { addPortletLinkHandler } = require( '../../../resources/skins.continuum.js/dropdownMenus.js' );

describe( 'addPortletLinkHandler', () => {
	beforeEach( () => {
		document.body.innerHTML = `
		<div id="p-views" class="continuum-menu">
			<div class="continuum-menu-content">
				<ul class="continuum-menu-content-list">
					<li id="pt-userpage" class="mw-list-item">
						<a href="#bar">
							<span class="continuum-icon mw-ui-icon-userAvatar mw-ui-icon-wikimedia-userAvatar"></span>
							<span>Admin</span>
						</a>
					</li>
				</ul>
		...
		<div id="p-personal" class="continuum-menu">
			 <div class="continuum-menu-content">
				<ul class="continuum-menu-content-list">
					<li id="pt-userpage" class="mw-list-item">
						<a href="#bar">
	...
	test( 'JS portlet should be moved to more menu (#p-cactions) at narrow widths', () => {
		...
		<div class="mw-article-toolbar-container" style="width:1000px">
			...
			<div id="right-navigation">
				<ul id="p-views" class="continuum-menu">
					<li class="mw-list-item mw-list-item-js" id="test-id">
						<a href="#test-href">
							<span>
								test link content
	...
	test( 'addPortletLinkHandler only adds icon class to p-personal menu', () => {
		...
		document
			.querySelector( '#p-personal .continuum-menu-content-list' )
		...
		expect( portletLinkItem.querySelectorAll( 'span.continuum-icon.mw-ui-icon-continuum-gadget-foo-id' ) ).toHaveLength( 1 );
	} );
	...
	test( 'addPortletLinkHandler does not add icons to p-views menu', () => {
		...
		// simulating addPortletLink appending to DOM from core.
		document
			.querySelector( '#p-views .continuum-menu-content-list' )
			.appendChild( portletLinkItem );
		...
		// Asserting that the icon classes were added.
		expect( portletLinkItem.querySelectorAll( 'span.mw-ui-icon.mw-ui-icon-continuum-gadget-foo-id' ) ).toHaveLength( 0 );
	} );
	...
	test( 'addPortletLinkHandler only adds one icon when an ID is specified - T327369', () => {
		...
		// simulating addPortletLink appending to DOM from core.
		const contentList = document.querySelector( '#p-personal .continuum-menu-content-list' );
		...
		expect( portletLinkItem1.querySelectorAll( 'span.continuum-icon.mw-ui-icon-continuum-gadget-foo' ) ).toHaveLength( 0 );
		expect( portletLinkItem2.querySelectorAll( 'span.continuum-icon.mw-ui-icon-continuum-gadget-bar' ) ).toHaveLength( 1 );
		expect( portletLinkItem3.querySelectorAll( 'span.continuum-icon.mw-ui-icon-continuum-gadget-baz' ) ).toHaveLength( 1 );
	} );
} );
