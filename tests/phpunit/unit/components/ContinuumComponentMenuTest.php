...
use ContinuumUniverses\Skins\Continuum\Components\ContinuumComponentMenu;
use MediaWikiUnitTestCase;

/**
 * @group Continuum
 * @group Components
 * @coversDefaultClass \ContinuumUniverses\Skins\Continuum\Components\ContinuumComponentMenu
 */
