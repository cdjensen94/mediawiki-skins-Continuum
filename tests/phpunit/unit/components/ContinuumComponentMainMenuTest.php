...
class ContinuumComponentMainMenuTest extends MediaWikiUnitTestCase {
	...
	/**
	 * This test checks if the ContinuumComponentMainMenu class can be instantiated
	 * @covers ::__construct
	 */
	public function testConstruct() {
		...
		// Create a new ContinuumComponentMainMenu object
		$mainMenu = new ContinuumComponentMainMenu(
			$sidebarData,
			$languageData,
			$localizerMock,
			$userMock,
		...
		// Assert that the object is an instance of ContinuumComponent
		$this->assertInstanceOf( ContinuumComponent::class, $mainMenu );
	}
	...
	public function testGetTemplateData( array $sidebarData, array $languageData, bool $isPinned ) {
		...
		$this->assertSame( 'continuum-main-menu', $templateData['id'] );
