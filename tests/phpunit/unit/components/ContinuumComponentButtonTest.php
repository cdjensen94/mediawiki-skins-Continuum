...
class ContinuumComponentButtonTest extends MediaWikiUnitTestCase {
	...
	/**
	 * Provides various configurations of ContinuumComponentButton to test different scenarios.
	...
	/**
	 * Tests CSS class generation logic within ContinuumComponentButton.
	 * This method verifies that the class string is generated correctly based on the button's properties.
	 *
	 * @covers ::getClasses
	 */
	public function testGetClasses() {
		$basicButton = new ContinuumComponentButton( 'Label' );
		...
		$primaryButton = new ContinuumComponentButton( 'Label', null, null, null, [], 'primary' );
		...
		$iconOnlyButton = new ContinuumComponentButton(
		...
		$destructiveButton = new ContinuumComponentButton( 'Label', null, null, null, [],
			'normal', 'destructive' );
		...
		$progressiveButton = new ContinuumComponentButton( 'Label', null, null, null, [],
			'normal', 'progressive' );
		...
		$quietButton = new ContinuumComponentButton( 'Label', null, null, null, [], 'quiet' );
	...
	/**
	 * Tests the `getTemplateData` method of ContinuumComponentButton component.
	...
	public function testGetTemplateData(
		...
		$button = new ContinuumComponentButton(
			$label,
			'icon-sample',
			'btn-id',
			'additional-class',
