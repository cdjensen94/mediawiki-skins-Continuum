 ...
 * @group Continuum
 * @group Components
 * @coversDefaultClass \ContinuumUniverses\Skins\Continuum\Components\ContinuumComponentPinnableContainer
 */
class ContinuumComponentPinnableContainerTest extends MediaWikiUnitTestCase {
	...
	public function testGetTemplateData() {
		...
		$pinnableContainerTrue = new ContinuumComponentPinnableContainer( $mockIdTrue, true );
		...
		$pinnableContainerFalse = new ContinuumComponentPinnableContainer( $mockIdFalse, false );
