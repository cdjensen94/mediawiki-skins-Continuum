...
function addDefaultPortlet( portlet ) {
	...
	// menus inside the legacy sidebar should have continuum-menu-portal class.
	if ( portlet.closest( '.continuum-legacy-sidebar' ) ) {
		portlet.classList.add( 'continuum-menu-portal' );
	}
...
function addPortletHandler( portlet ) {
	...
	if ( parent && parent.id === 'right-navigation' ) {
		const id = portlet.id;
		portlet.classList.add( 'continuum-menu-dropdown' );
		...
		checkbox.setAttribute( 'class', 'continuum-menu-checkbox' );
