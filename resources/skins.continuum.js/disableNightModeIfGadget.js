...
function isNightModeGadgetEnabled() {
	return mw.msg( 'continuum-night-mode-gadget-names' ).split( '|' ).some( ( gadget ) => {
...
function alterDisableLink( container ) {
	const gadgetNames = mw.msg( 'continuum-night-mode-gadget-names' );
...
function alterExclusionMessage() {
	...
	mw.loader.using( 'mediawiki.jqueryMsg' ).then( () => {
		...
		mw.message( 'continuum-night-mode-gadget-warning' ).parseDom().appendTo( noticeContainer );
