...
const SECTION_CLASS = 'continuum-toc-list-item';
const ACTIVE_SECTION_CLASS = 'continuum-toc-list-item-active';
const EXPANDED_SECTION_CLASS = 'continuum-toc-list-item-expanded';
const TOP_SECTION_CLASS = 'continuum-toc-level-1';
const ACTIVE_TOP_SECTION_CLASS = 'continuum-toc-level-1-active';
const LINK_CLASS = 'continuum-toc-link';
const TOGGLE_CLASS = 'continuum-toc-toggle';
 ...
 * @property {Section[]} array-sections
 * @property {boolean} continuum-is-collapse-sections-enabled
 * @property {string} msg-continuum-toc-beginning
 */
...
module.exports = function tableOfContents( props ) {
	...
	function bindPinnedToggleListeners() {
		const toggleButtons = document.querySelectorAll( '.continuum-toc-pinnable-header button' );
	...
	function updateTocToggleStyles( scrollBelow ) {
		const TOC_TITLEBAR_TOGGLE_ID = 'continuum-page-titlebar-toc-label';
	...
	function getTableOfContentsData( sections ) {
		...
		return {
			'msg-continuum-toc-beginning': mw.message( 'continuum-toc-beginning' ).text(),
			'array-sections': tableOfContentsLevel1Sections,
			'continuum-is-collapse-sections-enabled': tableOfContentsLevel1Sections.length > 3 && sections.length >= tableOfContentsConfig.ContinuumTableOfContentsCollapseAtCount
		};
	}
	 ...
	 * ContinuumComponentTableOfContents::getTemplateData(),
