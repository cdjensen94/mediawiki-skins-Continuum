...
const
	...
	CHECKBOX_HACK_CONTAINER_SELECTOR = '.continuum-dropdown',
	CHECKBOX_HACK_CHECKBOX_SELECTOR = '.continuum-dropdown-checkbox',
	CHECKBOX_HACK_BUTTON_SELECTOR = '.continuum-dropdown-label',
	CHECKBOX_HACK_TARGET_SELECTOR = '.continuum-dropdown-content';
...
function getAvailableViewMenuWidth() {
	const
		// Continuum toolbar containing namespace, views, more menu etc.
		toolbar = document.querySelector( '.continuum-page-toolbar-container' ),
