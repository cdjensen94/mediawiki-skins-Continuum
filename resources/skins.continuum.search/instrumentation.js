 ...
 *
 * @see https://gerrit.wikimedia.org/r/plugins/gitiles/mediawiki/skins/Continuum/+/refs/heads/master/includes/Constants.php
 */
const INPUT_LOCATION_MOVED = 'header-moved',
	// T251544: Collect search performance metrics to compare Vue search with
	// mediawiki.searchSuggest performance. Marks and Measures will only be
	// recorded on the Continuum skin and only if browser supported.
	...
	loadStartMark = 'mwContinuumVueSearchLoadStart',
	queryMark = 'mwContinuumVueSearchQuery',
	renderMark = 'mwContinuumVueSearchRender',
	queryToRenderMeasure = 'mwContinuumVueSearchQueryToRender',
	loadStartToFirstRenderMeasure = 'mwContinuumVueSearchLoadStartToFirstRender';
