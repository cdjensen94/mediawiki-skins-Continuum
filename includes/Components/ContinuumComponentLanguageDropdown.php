...
/**
 * ContinuumComponentLanguageButton component
 */
class ContinuumComponentLanguageDropdown implements ContinuumComponent {
	/** @var string */
	private $label;
	/** @var string */
	private $ariaLabel;
	...
	public function getTemplateData(): array {
		...
		$dropdown = new ContinuumComponentDropdown( 'p-lang-btn', $this->label, $this->class );
