...
/**
 * ContinuumComponentVariants component
 */
class ContinuumComponentVariants implements ContinuumComponent {
	...
	private function getDropdownData() {
		$dropdown = new ContinuumComponentDropdown(
			'continuum-variants-dropdown',
	...
	private function getMenuDropdownData() {
		...
		$menu = new ContinuumComponentMenu( $this->menuData );
