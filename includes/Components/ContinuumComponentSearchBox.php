...
/**
 * ContinuumSearchBox component
 */
class ContinuumComponentSearchBox implements ContinuumComponent {
	...
	/** @var Config */
	private $config;
	private const SEARCH_COLLAPSIBLE_CLASS = 'continuum-search-box-collapses';
	...
	public function getTemplateData(): array {
		...
		$searchClass = 'continuum-search-box-vue ';
		...
		$searchButton = new ContinuumComponentButton(
