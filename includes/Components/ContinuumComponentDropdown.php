...
/**
 * ContinuumComponentDropdown component
 */
class ContinuumComponentDropdown implements ContinuumComponent {
	/** @var string */
	private $id;
	/** @var string */
	private $label;
	...
	public function getTemplateData(): array {
		...
		return [
			...
			'icon' => $this->icon,
			'html-continuum-menu-label-attributes' => '',
			'html-continuum-menu-checkbox-attributes' => '',
			'class' => $this->class,
