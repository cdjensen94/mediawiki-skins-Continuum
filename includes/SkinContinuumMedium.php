 ...
 * @internal
 */
class SkinContinuumMedium extends SkinMustache {
	public $skinname = 'continuum-light';
    public $stylename = 'continuum-light';
    public $template = 'skin-light';

    public function initPage(OutputPage $out) {
        parent::initPage($out);
        $out->addModuleStyles('skins.continuumlight.styles');
	}
	...
	public function initPage( $out){
		$out->addModuleStyles( 'skins.continuummedium.styles' ); // Theme-specific styles
	}
}
