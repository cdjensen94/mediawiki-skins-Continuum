...
class OverrideableRequirementHelper {
	...
	public function __construct(
		...
		$this->overrideName = 'continuum' . strtolower( $requirementName );
	...
	public function isMet(): ?bool {
		...
		$continuumReq = 'Continuum' . $this->requirementName;
		if ( $this->request->getCheck( $continuumReq ) ) {
			return $this->request->getBool( $continuumReq );
		}
		return null;
	}
}
