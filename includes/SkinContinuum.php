...
class SkinContinuum extends SkinMustache {
	public $skinname = 'continuum';
    public $stylename = 'continuum';
    public $template = 'skin-continuum'; // Or your custom template if you have one

    public function initPage(OutputPage $out) {
        parent::initPage($out);
        $out->addModuleStyles('skins.continuum.styles');
	}
	...
	public function getTemplateData(): array {
		...
		$components = $tocComponents + [
			...
			$data['data-continuum-sticky-header'] = $featureManager->isFeatureEnabled(
